...
import react__default, { ComponentProps as ComponentProps$1, ElementType, ReactNode } from 'react';
...
declare function MultiStep({ size, currentStep }: MultiStepProps): react__default.JSX.Element;
...
declare function Toast({ title, description, ...props }: ToastProps): react__default.JSX.Element;
...
declare function Tooltip({ content, children, ...props }: TooltipProps): react__default.JSX.Element;
